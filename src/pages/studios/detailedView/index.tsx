...
import { getStudio } from "../../../api/queries";
            ...
            <div className="flex flex-col space-y-12 dark:text-white">
                <div className="flex flex-row gap-4">
                    ...
                    <div
                        ...
                        data-tip
                        data-for="studioFav"
                        className="flex items-center rounded-full px-4 my-1 dark:bg-gray-800">
                        <p className="font-semibold uppercase text-sm">{data?.favourites} </p>
                        <HiStar/>
                    </div>
                    <ReactTooltip
                        id="studioFav"
                        ...
                        <span>{data?.favourites} people like this studio</span>
                    </ReactTooltip>
                </div>
                <MediaList data={data} />
                <PopularAnime />
